...
@click.option('--append', is_flag=True, help='Automatically append to shell config file')
...
"""
    ...
    if append:
        ...
        try:
            ...
            console.print(f"[green]✓ Successfully added completion script to {config_file}[/]")
