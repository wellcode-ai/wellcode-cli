...
3. Team queries:
   - Only add --team flag when a specific team name is mentioned
   - "team performance" (without team name) → "review" (no team flag)
   - "team frontend performance" → "review --team frontend"
   - "check team backend" → "review --team backend"
   - If no specific team is mentioned, don't add the --team flag
